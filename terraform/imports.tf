# One-off imports to bring resources that already exist in Azure (created
# before this state existed, or before a remote backend was configured)
# under Terraform's management. Safe to delete once `terraform apply` has
# run successfully and `terraform state list` shows all of these.
